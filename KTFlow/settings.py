...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-6)@ob43%k=2*q7@on*(nnq5x(l8xej0y2^-i4%&8stftmn^$g!')
...
CACHES = {
    "default": {
        ...
        "LOCATION": os.environ.get('REDIS_BROKER_URL', 'redis://localhost:6379/1'),  # adjust host/port/db as needed
        "OPTIONS": {
